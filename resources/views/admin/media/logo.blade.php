    ...
    <div class="page-header justify-content-between">
        ...
        <div class="dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-right">
                <a class="dropdown-item" id="btn_add_logo">Add Logo</a>
                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table id="orders" class="table table-lg">
                            ...
                            <tbody>
                                @foreach($param['logo_list'] as $row)
                                <tr>
                                    <td></td>
                                    <td>
                                        <a href="#">{{ $row->id }}</a>
            ...
            <div class="modal fade" id="logo_config_modal"  tabindex="-1" role="dialog" aria-labelledby="staticBackdropLabel" aria-hidden="true">
				<div class="modal-dialog">
					<div class="modal-content">
                        ...
                        <form method="POST" action="{{ url('/logo/addNewLogo') }}" enctype="multipart/form-data">
                            @csrf
                        ...
                        <div class="modal-footer">
                            <button type="submit" class="btn btn-primary" id="save_logo_info">Save Logo</button>
                        </div>
                        </form>
                    </div>
				</div>
...
@section('script')
    ...
    <script>
        ...
        function removeLogoInfo(logo_id)
        {
            if (confirm("\nDo you want to remove this logo?")) {
                $.ajax({
          
                    type:'POST',
                    url: APP_URL + '/logo/removeLogo',
                    data:{
                        logo_id: logo_id,                 
                    },
                    async:false,
                    success:function(data){
                        window.location.href = "{{ url('/admin/media/logo') }}";
                    }   
                });
            }
        }
