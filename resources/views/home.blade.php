...
@section('content')
	...
	<section>
		<div class="banner-section w-100">
			...
			<div class="banner-cantent">
				<h1 class="mb-0 mb-md-3" style="padding-left: 100px;">
					LOS MEJORES ESPECIALISTAS AL ALCANCE 
				</h1>
				<h1 class="mb-0 mb-md-3" style="padding-left: 100px;">
					DETU MANO
				</h1>
				<h1 class="mb-0 mb-md-3" style="color:#069ccb; padding-left: 100px;">
					¡AGENDA TU CITA YA!
				</h1>
				<div class="container">
				...
				<div class="row align-items-center">
					...
					<div class="col-md-5 col-12 my-3 my-md-0 register-section">
						...
						<form>
                            ...
                            <button type="submit" class="btn btn-primary" style="margin-top: 20px;">REGÍSTRATE</button>
			...
			<div class="container">
				...
				<div class="owl-carousel align-items-center" id="sponsor">
					@foreach($param['partner_logos'] as $row)	
						<div class="sponsors">
							<img src="{{ url('public/images/partner_logos'). '/'. $row->title }}" class="img-fluid" alt="sponsor" >
						</div>
					@endforeach
				</div>
			</div>
					...
					<div class="col-md-6 col-12">
						<div class="contact-info">
							<h6>
								...
								<a href="">Politica de Privacidad</a> - <a href="">Terminos y Condiciones</a> - <a href="">Contacto</a><br/>
							</h6>
						</div>
					</div>
					<div class="col-md-3 col-12">
